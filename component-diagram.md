...
graph TB
%% External Layer
Client[Client Applications<br/>REST API Consumers]

%% Presentation Layer - Controllers
subgraph "Presentation Layer"
TC[TaskController<br/>@RestController<br/>@RequestMapping Task]
UC[UserController<br/>@RestController<br/>@RequestMapping User]
end
...
TaskEntity[Task Entity<br/>@Entity<br/>- id: Integer<br/>- taskName: String<br/>- taskDescription: String<br/>- taskStatus: String<br/>- taskPriority: Integer<br/>- taskDueDate: Date<br/>- taskCreatedBy: User]
UserEntity[User Entity<br/>@Entity<br/>- id: Integer<br/>- firstName: String<br/>- lastName: String<br/>- userName: String<br/>- userEmail: String<br/>- userPassword: String<br/>- tasks: List of Task]
end
...
TaskEntity -->|@ManyToOne<br/>@JoinColumn| UserEntity
UserEntity -->|@OneToMany<br/>mappedBy taskCreatedBy| TaskEntity
